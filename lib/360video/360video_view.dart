...
class _VideoPlayerPageState extends State<VideoPlayerPage>
                ...
                child: ColoredBox(
                  ...
                  child: Row(
                    children: <Widget>[
                      ...
                      Expanded(
                        child: m.SliderTheme(
                          data: m.SliderTheme.of(context).copyWith(
                            activeTrackColor: m.Colors.amberAccent,
                            inactiveTrackColor: Colors.grey,
                            trackHeight: 5,
                            thumbColor: Colors.white,
                            thumbShape: const m.RoundSliderThumbShape(
                              enabledThumbRadius: 8,
                            ),
                            overlayColor: Colors.purple.withAlpha(32),
                            overlayShape: const m.RoundSliderOverlayShape(
                              overlayRadius: 14,
                            ),
                          ),
                          child: Slider(
  ...
  void onViewPlayerCreated(
    ...
    _viewPlayerController.loadVideo(
      videoPath:
          "F:\\Downloads\\vecteezy_abstract-circular-curvature-of-surface-of-earth-and-twisting_14477444.mp4",
    );
  }
